...
extern "C" SEXP _RSQLCipher_connection_connect(SEXP path, SEXP allow_ext, SEXP flags, SEXP vfs, SEXP with_alt_types) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_valid(SEXP con_) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_release(SEXP con_) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_in_transaction(SEXP con_) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_add_transaction(SEXP con_) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_rem_transaction(SEXP con_) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_copy_database(SEXP from, SEXP to) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_connection_import_file(SEXP con, SEXP name, SEXP value, SEXP sep, SEXP eol, SEXP skip) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_set_busy_handler(SEXP con, SEXP r_callback) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_extension_load(SEXP con, SEXP file, SEXP entry_point) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_create(SEXP con, SEXP sql) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_release(SEXP res) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_valid(SEXP res_) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_fetch(SEXP res, SEXP n) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_bind(SEXP res, SEXP params) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_has_completed(SEXP res) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_rows_fetched(SEXP res) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_rows_affected(SEXP res) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_column_info(SEXP res) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_result_get_placeholder_names(SEXP res) {
  BEGIN_CPP11
...
extern "C" SEXP _RSQLCipher_rsqliteVersion() {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_RSQLCipher_connection_add_transaction",   (DL_FUNC) &_RSQLCipher_connection_add_transaction,   1},
    {"_RSQLCipher_connection_connect",           (DL_FUNC) &_RSQLCipher_connection_connect,           5},
    {"_RSQLCipher_connection_copy_database",     (DL_FUNC) &_RSQLCipher_connection_copy_database,     2},
    {"_RSQLCipher_connection_import_file",       (DL_FUNC) &_RSQLCipher_connection_import_file,       6},
    {"_RSQLCipher_connection_in_transaction",    (DL_FUNC) &_RSQLCipher_connection_in_transaction,    1},
    {"_RSQLCipher_connection_release",           (DL_FUNC) &_RSQLCipher_connection_release,           1},
    {"_RSQLCipher_connection_rem_transaction",   (DL_FUNC) &_RSQLCipher_connection_rem_transaction,   1},
    ...
    {"_RSQLCipher_result_fetch",                 (DL_FUNC) &_RSQLCipher_result_fetch,                 2},
    {"_RSQLCipher_result_get_placeholder_names", (DL_FUNC) &_RSQLCipher_result_get_placeholder_names, 1},
    {"_RSQLCipher_result_has_completed",         (DL_FUNC) &_RSQLCipher_result_has_completed,         1},
    {"_RSQLCipher_result_release",               (DL_FUNC) &_RSQLCipher_result_release,               1},
    {"_RSQLCipher_result_rows_affected",         (DL_FUNC) &_RSQLCipher_result_rows_affected,         1},
    {"_RSQLCipher_result_rows_fetched",          (DL_FUNC) &_RSQLCipher_result_rows_fetched,          1},
    {"_RSQLCipher_result_valid",                 (DL_FUNC) &_RSQLCipher_result_valid,                 1},
    {"_RSQLCipher_rsqliteVersion",               (DL_FUNC) &_RSQLCipher_rsqliteVersion,               0},
    {"_RSQLCipher_set_busy_handler",             (DL_FUNC) &_RSQLCipher_set_busy_handler,             2},
    {NULL, NULL, 0}
};
}

extern "C" attribute_visible void R_init_RSQLCipher(DllInfo* dll){
