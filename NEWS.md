...
## Other
- Update bundled SQLCipher to version 4.19.0 (SQLite 3.53.4).

# RSQLCipher 0.4.8

## Other
- Update bundled SQLCipher to version 4.18.0 (SQLite 3.53.4).
...
## Other
- Update bundled SQLCipher to version 4.14.0 (SQLite 3.51.3).

# RSQLCipher 0.4.4

## Other
- Update bundled SQLCipher to version 4.13.0 (SQLite 3.51.2).
...
## Other
- Update bundled SQLCipher to version 4.11.0 (SQLite 3.50.4).

# RSQLCipher 0.4.1

## Other
- Update bundled SQLCipher to version 4.10.0 (SQLite 3.50.4).
...
## Other
- Update bundled SQLCipher to version 4.5.7 (SQLite 3.45.3).
